...
public partial class OptimizerViewModel : ViewModelBase
{
    ...
    public IPopupToolTipService ToolTipService { get; }
    ...
    public OptimizerViewModel(AssetManager assetManager, SourceDataManager sourceDataManager, ResultDataManager resultDataManager, IPopupService popupService, IPopupToolTipService toolTipService)
    {
