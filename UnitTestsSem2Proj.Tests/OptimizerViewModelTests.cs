...
namespace Sem2Proj.Tests
{
    public class OptimizerViewModelTests
    {
        ...
        public OptimizerViewModelTests()
        {
            ...
            _viewModel = new OptimizerViewModel(_mockAssetManager.Object, _mockSourceDataManager.Object, _mockResultDataManager.Object);
        }
        ...
        public void Constructor_WithNullAssetManager_ShouldThrowArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => 
                new OptimizerViewModel(null, _mockSourceDataManager.Object, _mockResultDataManager.Object));
        }
        ...
        public void Constructor_WithNullSourceDataManager_ShouldThrowArgumentNullException()
        {
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => 
                new OptimizerViewModel(_mockAssetManager.Object, null, _mockResultDataManager.Object));
        }
        ...
        public void Constructor_WithNullResultDataManager_ShouldThrowArgumentNullException()
        {
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => 
                new OptimizerViewModel(_mockAssetManager.Object, _mockSourceDataManager.Object, null));
        }
        ...
        public void SwitchGraph_WithHeatProductionType_ShouldUpdateView()
        {
            ...
            // Act
            _viewModel.SwitchGraph(OptimizerViewModel.GraphType.HeatProduction);
